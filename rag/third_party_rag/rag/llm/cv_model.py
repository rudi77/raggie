...
from rag.third_party_rag.rag.nlp import is_english
...
class GptV4(Base):
    def __init__(self, key, model_name="gpt-4o-mini", lang="German", base_url="https://api.openai.com/v1"):
        if not base_url:
...
class AzureGptV4(Base):
    def __init__(self, key, model_name, lang="German", **kwargs):
